      ...
      <div className="d-flex d-flex justify-content-center">
        <table className="table table-bordered">
          ...
          <tbody className="text-center">
            <tr>
              <td className={`${styles.textTable2}`}>Kinder Colores</td>
              <td className={`${styles.textTable2}`}>Calle dos </td>
              ...
              <td >
                ...
                <button style={{ background: "transparent", border: "none", padding: 0, cursor: "pointer" }}><img src="/5.png" alt="Ícono personalizado" style={{ width: "25px", height: "25px" }} /></button>              </td>
