...
function getButtonStyle(nombre: string) {
  ...
  return (
    <Layout>
      <div
        style={{ backgroundColor: "#0857a1", width: "100%", height: "90px" }}
        className="text-white d-flex justify-content-center align-items-center m-0"
      >
        <h5 className="m-0 py-3" style={{ fontWeight: "100" }}>
